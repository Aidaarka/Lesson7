...
namespace ConsoleApp1.Second
{
    ...
    class DrinkBuying
    {
        static void Main()
        {
            Dictionary<CoffeeMachine, CoffeeMachine> users = new Dictionary<CoffeeMachine, CoffeeMachine>
            {
            ...
            foreach (KeyValuePair<CoffeeMachine, CoffeeMachine> keyValue in users)
            {
